...
export default function CourseInfo() {
  ...
  const handleSaveSyllabus = (data: any) => {
    const currentSyllabus = courseSyllabus?.syllabus || [];
    if (editSyllabus === -1) {
    ...
    <div className="container mx-auto p-4 space-y-6">
      ...
      {editSyllabus !== undefined ? (
        <SyllabusEditor
          initialData={
            editSyllabus !== -1
              ? courseSyllabus?.syllabus[editSyllabus]
              : undefined
          }
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-2 mt-2">
              {courseSyllabus ? (
                courseSyllabus.syllabus.map((item, index) => (
                  <div className="flex justify-between">
                    ...
                    <div className="flex space-x-2">
                      ...
                      <Trash2
                        ...
                        onClick={() => {
                          const newSyllabus = courseSyllabus.syllabus.filter(
                            (v, i) => i !== index
                          );
                          updateSyllabus(id, {
